    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <form:form modelAttribute="boardUseInf" name="boardUseInf" method="post" action="${pageContext.request.contextPath}/cop/com/updateBBSUseInf.do">
                    ...
                    <div class="modify_user" >
                        <table summary="게시판명, 커뮤니티/ 동호회명, 사용여부  입니다">
					      ...
					      <tr> 
					        ...
					        <td width="80%" nowrap colspan="3">
					            <spring:message code="button.use" /> : <form:radiobutton path="useAt" cssClass="radio2" value="Y" />&nbsp;
					            <spring:message code="button.notUsed" /> : <form:radiobutton path="useAt" cssClass="radio2" value="N" />
