...
public class BoardMaster implements Serializable {
	...
	/** 게시판 속성코드 */
    @NotBlank(message = "게시판 속성은 필수입니다.")
    ...
    @Size(max = 2000, message = "게시판 소개는 2000자 이하여야 합니다.")
    private String bbsIntrcn = "";

    /** 게시판 명 */
    @NotBlank(message = "게시판명은 필수입니다.")
    @Size(max = 120, message = "게시판명은 120자 이하여야 합니다.")
    ...
    /** 파일첨부가능여부 */
    @NotBlank(message = "파일첨부 가능 여부는 필수입니다.")
    @Pattern(regexp = "Y|N", message = "파일첨부 가능 여부는 Y 또는 N 이어야 합니다.")
    ...
    /** 첨부가능파일숫자 */
    @Max(value = 3, message = "첨부파일 수는 3 이하여야 합니다.")
    ...
    /** 답장가능여부 */
    @NotBlank(message = "답장 가능 여부는 필수입니다.")
    @Pattern(regexp = "Y|N", message = "답장 가능 여부는 Y 또는 N 이어야 합니다.")
