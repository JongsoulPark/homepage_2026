                        ...
                        <table>
                          <tr> 
					        ...
					        <td width="80%" nowrap="nowrap" colspan="3">
					          <form:input path="nttSj" id="nttSj" size="60" maxlength="1200" />
					          <br/><form:errors path="nttSj" cssClass="error" />
					        </td>
					      </tr>
					      <tr> 
					        ...
					        <td colspan="3">
					          <form:textarea path="nttCn" id="nttCn" cssClass="textarea" cols="75" rows="20" cssStyle="width:99%;" />
