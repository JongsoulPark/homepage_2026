                        ...
                        <table summary="게시판명, 커뮤니티 동호회 정보  입니다">
					      <tr>   
					        ...
					        <td width="70%" nowrap colspan="3">
					          ...
					          <form:input path="bbsNm" size="40" maxlength="40" readonly="true" /> 
					        ...
					        <br/><form:errors path="bbsId" cssClass="error" />                   
					        </td>
					      </tr>
					      <tr> 
					        ...
					        <td width="70%" nowrap colspan="3">
					           <form:select path="trgetType" id="trgetType" cssClass="select" onchange="javascript:fn_egov_selectTargetType(this)">
					               <option selected value=''>--선택하세요--</option>
					               <option value="SYSTEM" >시스템</option>            
					           </form:select>
					           <form:hidden path="trgetId" />
					           <form:input path="trgetNm" size="40" readonly="true" />
					           <br/><form:errors path="trgetId" cssClass="error" />
					        </td>
					      </tr>
                        </table>
                    </div>
