...
public class EgovTemplateManageController {
    ...
    @ModelAttribute("templateInf")
    public TemplateInf templateInf() {
    ...
    public String selectTemplateInf(@ModelAttribute("searchVO") TemplateInfVO tmplatInfVO, ModelMap model) throws Exception {
		...
		model.addAttribute("templateInf", vo);
    ...
    public String insertTemplateInf(@ModelAttribute("searchVO") TemplateInfVO searchVO, @Valid @ModelAttribute("templateInf") TemplateInf templateInf,
		...
		if (bindingResult.hasErrors()) {
		    model.addAttribute("resultList", selectTemplateTypeCodes());
    ...
    private List<?> selectTemplateTypeCodes() throws Exception {
        ComDefaultCodeVO codeVO = new ComDefaultCodeVO();
        codeVO.setCodeId("COM005");
        return cmmUseService.selectCmmCodeDetail(codeVO);
    }
}
