...
public class EgovBBSAttributeManageController {
    ...
    public String addBBSMaster(@ModelAttribute("searchVO") BoardMasterVO boardMasterVO, ModelMap model) throws Exception {
		...
		populateBoardMasterCodes(model);
    ...
    public String updateBBSMasterInf(@ModelAttribute("searchVO") BoardMasterVO boardMasterVO, @Valid @ModelAttribute("boardMaster") BoardMaster boardMaster,
		...
		if (bindingResult.hasErrors()) {
		    model.addAttribute("result", boardMaster);
		    return "cop/bbs/EgovBoardMstrUpdt";
		}
    ...
    public String insertBdMstrByTrget(@ModelAttribute("searchVO") BoardMasterVO boardMasterVO,
	    @Valid @ModelAttribute("boardMaster") BoardMaster boardMaster, BindingResult bindingResult, SessionStatus status, ModelMap model)
	    throws Exception {
    ...
    public String updateBBSMasterInfByTrget(@ModelAttribute("searchVO") BoardMasterVO boardMasterVO,
	    @Valid @ModelAttribute("boardMaster") BoardMaster boardMaster, BindingResult bindingResult, ModelMap model) throws Exception {
    ...
    private void populateBoardMasterCodes(ModelMap model) throws Exception {
        ComDefaultCodeVO codeVO = new ComDefaultCodeVO();
        codeVO.setCodeId("COM004");
        model.addAttribute("typeList", cmmUseService.selectCmmCodeDetail(codeVO));
        codeVO.setCodeId("COM009");
        model.addAttribute("attrbList", cmmUseService.selectCmmCodeDetail(codeVO));
    }
}
