                        ...
                        <table >
					      <tr> 
					        ...
					        <td width="80%" nowrap="nowrap">
					          ...
					          <form:input path="tmplatNm" id="tmplatNm" size="60" maxlength="120" cssStyle="width:100%" readonly="true" />
					          <br/><form:errors path="tmplatNm" cssClass="error" />   
					        </td>
					      </tr>
					      <tr> 
					        ...
					        <td>
					        <form:select path="tmplatSeCode" id="tmplatSeCode" cssClass="select" onchange="fn_egov_selectTmplatType(this)">
					               <form:option value="" label="--선택하세요--" />
					               <form:options items="${resultList}" itemValue="code" itemLabel="codeNm" />
					        </form:select>&nbsp;&nbsp;&nbsp;<span id="sometext"></span>
					        <br/><form:errors path="tmplatSeCode" cssClass="error" /> 
					        </td>
					      </tr> 
					      <tr> 
					        ...
					        <td width="80%" nowrap="nowrap">
					          <form:input path="tmplatCours" id="tmplatCours" size="60" maxlength="2000" cssStyle="width:100%" />
					          <br/><form:errors path="tmplatCours" cssClass="error" /> 
					        </td>
					      </tr>
					      <tr> 
					        <th width="20%" height="23" class="required_text" nowrap >
					        ...
					        <td width="80%" nowrap="nowrap">
					            Y : <form:radiobutton path="useAt" cssClass="radio2" value="Y" />&nbsp;
					            N : <form:radiobutton path="useAt" cssClass="radio2" value="N" />
