                        ...
                        <table >
					      <tr> 
					        ...
					        <td width="80%" nowrap="nowrap">
					          <form:input path="tmplatNm" id="tmplatNm" size="60" maxlength="120" cssStyle="width:100%" />
					      ...
					      <tr> 
					        ...
					        <td>
					        <form:select path="tmplatSeCode" cssClass="select" onchange="fn_egov_selectTmplatType(this)" id="tmplatSeCode">
