...
public class TemplateInf implements Serializable {
    ...
    /** 템플릿 경로 */
    @NotBlank(message = "템플릿 경로는 필수입니다.")
    @Size(max = 2000, message = "템플릿 경로는 2000자 이하여야 합니다.")
    ...
    @Size(max = 120, message = "템플릿명은 120자 이하여야 합니다.")
    private String tmplatNm = "";

    /** 탬플릿 구분코드 */
    @NotBlank(message = "템플릿 구분은 필수입니다.")
    private String tmplatSeCode = "";

    /** 사용여부 */
    @NotBlank(message = "사용 여부는 필수입니다.")
    @Pattern(regexp = "Y|N", message = "사용 여부는 Y 또는 N 이어야 합니다.")
