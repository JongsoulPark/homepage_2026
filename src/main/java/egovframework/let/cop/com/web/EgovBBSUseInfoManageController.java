...
public class EgovBBSUseInfoManageController {
    ...
    @ModelAttribute("boardUseInf")
    public BoardUseInfVO boardUseInf() {
        BoardUseInfVO boardUseInf = new BoardUseInfVO();
    ...
    public String insertBBSUseInf(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, @Valid @ModelAttribute("boardUseInf") BoardUseInfVO boardUseInf,
    ...
    public String updateBBSUseInf(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, @Valid @ModelAttribute("boardUseInf") BoardUseInfVO boardUseInf,
	    BindingResult bindingResult, HttpServletRequest request, ModelMap model) throws Exception {

    	if (!checkAuthority(model)) return "cmm/uat/uia/EgovLoginUsr";	// server-side 권한 확인

    	if (bindingResult.hasErrors()) {
    		BoardUseInfVO current = bbsUseService.selectBBSUseInf(bdUseVO);
    		current.setUseAt(boardUseInf.getUseAt());
    		model.addAttribute("boardUseInf", current);
    		model.addAttribute("bdUseVO", current);
	...
	BoardUseInfVO vo = bbsUseService.selectBBSUseInf(bdUseVO);
		...
		model.addAttribute("boardUseInf", vo);
		return "cop/com/EgovBoardUseInfInqire";
    }
